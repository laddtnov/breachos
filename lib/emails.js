const BASE_URL = 'https://breachos.app/';
    ...
    <tr><td align="center">
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:560px;background-color:#08080f;border:2px solid #00f3ff;border-radius:12px;box-shadow:0 0 30px rgba(0,243,255,0.3);">
        ...
        <tr><td style="padding:0 36px 32px;text-align:center;">
          ...
          <p style="margin:0;font-size:10px;letter-spacing:2px;color:rgba(255,255,255,0.2);text-transform:uppercase;">breachos.app</p>
        </td></tr>
      </table>
    </td></tr>
  </table>
